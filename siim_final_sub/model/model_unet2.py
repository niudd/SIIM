...
from sync_batchnorm import SynchronizedBatchNorm2d, DataParallelWithCallback, patch_replication_callback
...
class UNetResNet34(nn.Module):
    ...
    def __init__(self, pretrained=True, debug=False):
        ...
        self.decoder5 = Decoder(512+256, 512, 32)#64
        self.decoder4 = Decoder(256+32, 256, 32)
        self.decoder3 = Decoder(128+32, 128,  32)
        self.decoder2 = Decoder( 64+ 32, 64, 32)
